...
import com.stackwizards.custom.fragmentlibrary.fragment.DownloadFragment;
import com.stackwizards.custom.fragmentlibrary.fragment.HelpInfoFragment;
import com.stackwizards.custom.fragmentlibrary.fragment.LeaderBoardFragment;
import com.stackwizards.custom.fragmentlibrary.fragment.OfflineFragment;
import com.stackwizards.custom.fragmentlibrary.fragment.OnlineFragment;
import com.stackwizards.custom.fragmentlibrary.fragment.entity.WizardUser;
import com.stackwizards.custom.mybasiclib.LoginActivity;
import com.stackwizards.custom.fragmentlibrary.fragment.utils.FirebaseServiceUtils;

import static com.stackwizards.custom.fragmentlibrary.fragment.utils.FirebaseServiceUtils.uploadProfilePictureToFirebase;
import static com.stackwizards.custom.fragmentlibrary.fragment.utils.GraphicsUtils.getRoundedCornerBitmap;
import static com.stackwizards.custom.fragmentlibrary.fragment.utils.StorageUtils.isExternalStorageAvailable;
import static com.stackwizards.custom.fragmentlibrary.fragment.utils.StorageUtils.isExternalStorageReadOnly;


public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {
    private static final int AUTH_STATUS = 007;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intent = new Intent(this, com.stackwizards.custom.mybasiclib.LoginActivity.class);
        startActivityForResult(Intent.createChooser(intent, "FIREBASE AUTH"), AUTH_STATUS);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.nav_logout:
                ...
                Class<MainActivity> actResolve = MainActivity.class;
                i.putExtra("key",actResolve);
                startActivity(i);
    ...
    private void syncWizardUser() {
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (wizardUser == null) { // IF USER IS NEW
